  ...
  return (
    <LegalPageLayout onNavigate={onNavigate} lastUpdated="July 19, 2026">
      <section>
        ...
        <p>By using Steady, you agree to these terms. If you don't agree, please don't use the app.</p>
      </section>

      <section>
        <h2>What Steady is</h2>
        <p>
          Steady is a personal tracking tool for Wegovy (semaglutide) doses, weight, blood glucose, and
      ...
      <section>
        ...
        <p>
          Steady is not a diagnostic or medical-advice tool. It does not interpret your readings, flag
          "dangerous" values, or recommend dosage changes — it only records what you enter. Steady is not a
      ...
      <section>
        ...
        <p>
          ...
          for anything posted from your account. Steady is intended for adults managing their own
          treatment.
        </p>
      </section>
      ...
      <section>
        <h2>Your content</h2>
        <p>
          You own the photos and text you post. By sharing something to Community, you give Steady
      ...
      <section>
        ...
        <ul>
          ...
          <li>Using Steady for anything unlawful, or to distribute malware or spam</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>
          Steady is provided "as is," without warranties of any kind. To the fullest extent permitted by
